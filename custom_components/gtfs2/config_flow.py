...
from .notifications import check_extraction_result, async_watch_extraction
...
class ConfigFlow(ReloadScreens, TrainScreens, config_entries.ConfigFlow, domain=DOMAIN):
