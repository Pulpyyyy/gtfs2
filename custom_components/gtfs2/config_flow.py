...
from .const import CONF_NEEDS_API_KEY, CONF_ADD_RETURN, TRANSLATION_DESCRIPTION_PLACEHOLDERS
from .flow_train import TrainScreens
from .flow_reload import ReloadScreens
from .flow_source import _source_rt_schema, _source_key_schema, _source_rt_key_schema, _collect_source_rt_options
...
class ConfigFlow(SourceScreens, ReloadScreens, TrainScreens, config_entries.ConfigFlow, domain=DOMAIN):
